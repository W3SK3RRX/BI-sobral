        ...
        <Card className="shadow-orange-lg border-0">
          <CardHeader className="text-center space-y-4">
            <div className="flex flex-col items-center space-y-3">
              <img src="/media/logo.png" alt="Logo BI Sobral" className="w-16 h-16 object-contain" />
              <CardTitle className="text-2xl font-extrabold text-gradient-orange tracking-tight">PowerBI - Sobral</CardTitle>
